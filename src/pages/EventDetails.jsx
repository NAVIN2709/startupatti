        ...
        <div className="relative h-[400px] md:h-[500px] w-full overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 w-full z-20 p-6 md:p-12">
            <div className="container mx-auto">
              ...
              <div className="flex flex-col md:flex-row gap-2 md:gap-8 text-gray-400 md:text-gray-300 text-sm md:text-base">
              ...
              {event.upcoming && event.ticketLink && (
                <div className="mt-6 md:mt-8">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 bg-yellow-600 hover:bg-yellow-700 text-black font-bold py-2.5 md:py-3 px-6 md:px-8 rounded-full transition-all transform hover:scale-105 shadow-lg shadow-yellow-500/20 text-white text-sm md:text-base"
                  >
                    <Ticket size={18} />
                    Book Tickets
                  </a>
